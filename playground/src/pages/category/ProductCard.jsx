...
class ProductCard extends React.Component {
    ...
    handleOnProductCard = () => {
        this.props.setSelectedProductId([this.props.item.id, this.state.currentCurrency]);
    }
    ...
    render() {
        return (
            ...
            ((this.state.currentCurrency === null) && (!this.props.item.length)) ? <>Loading card...</> :
            ...
            <div className="product-card" onClick={() => this.handleOnProductCard()}>
                ...
                <div className="product-card_description">
                    ...
                    <p className="product-card_description_currency">
                        {this.props.item.prices[this.state.currentCurrency].currency.symbol}
                        {this.props.item.prices[this.state.currentCurrency].amount}
                    </p>
                </div>
